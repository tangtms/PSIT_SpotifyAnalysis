...
custom_style = Style(
  colors=('#e2e2e2','#1ed65f', '#19a56f', '#42a5f5', '#1e88e5', '#9575cd', '#ff7043', '#ffa725', '#78909c', '#296d8b', '#294d6b'), opacity='.85', opacity_hover='.95')

pie_chart = pygal.Pie(style=custom_style, legend_at_bottom=True, height=500)
